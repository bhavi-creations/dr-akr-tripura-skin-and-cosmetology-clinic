        ...
        <div class="container">
                 <div class="row">
                    ...
                    Your browser does not support the video tag.
                                ...
                                echo "<a href='fullblogs.php?id={$blog_id}' class='btn btn-primary'>Read more</a>";
                     ...
                     <div class="mt-5 d-none d-md-block">
                         <a href="blogs.php" style="text-decoration: none;">
                             <p class="view_more_btn mb-5 d-flex flex-row justify-content-start">View More 
                             </p>
                         </a>
                     </div>
                     ...
                     <div class="d-flex flex-row justify-content-center mt-4">
                         <a href="blogs.php" style="text-decoration: none;">
                             <p class="view_more_btn d-md-none">View More 
                             </p>
                         </a>
                     </div>
