...
<head>
    ...
    <title>Tripura skin - Dashboard</title>
                                    ...
                                    <form style='color:black;' id="editblogform" action="addBlog.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="filter-section mb-3">
                                            ...
                                            <select id="service" name="service" class="form-control" required>
                                                ...
                                                <option value="Hair Care" <?php echo ($service == 'Hair Care') ? 'selected' : ''; ?>>Hair Care</option>
                                                <option value="Pigmentation" <?php echo ($service == 'Pigmentation') ? 'selected' : ''; ?>>Pigmentation</option>
                                                <option value="Dark Circles" <?php echo ($service == 'Dark Circles') ? 'selected' : ''; ?>>Dark Circles</option>
                                                <option value="Acne Acne Scars Treatment" <?php echo ($service == 'Acne Acne Scars Treatment') ? 'selected' : ''; ?>>Acne & Acne Scars Treatment</option>
                                                <option value="Glowing Skin" <?php echo ($service == 'Glowing Skin') ? 'selected' : ''; ?>>Glowing Skin</option>
                                                <option value="Others" <?php echo ($service == 'Others') ? 'selected' : ''; ?>>Others</option>
