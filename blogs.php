...
<body>
    ...
    <div class="container ned_space_for_top_filter">
      <div class="filter_buttons redirect_section mt-4">
        ...
        <a href="blogs.php?service=Hair Care"><button class="redirect_blog_srivice">Hair Care</button></a>
        <a href="blogs.php?service=Pigmentation"><button class="redirect_blog_srivice">Pigmentation</button></a>
        <a href="blogs.php?service=Age Control"><button class="redirect_blog_srivice">Age Control</button></a>
        <a href="blogs.php?service=Dark Circles"><button class="redirect_blog_srivice">Dark Circles</button></a>
        <a href="blogs.php?service=Acne Acne Scars Treatment"><button class="redirect_blog_srivice">Acne & Acne Scars Treatment</button></a>
        <a href="blogs.php?service=Glowing Skin"><button class="redirect_blog_srivice">Glowing Skin</button></a>
        <a href="blogs.php?service=Others"><button class="redirect_blog_srivice">Others</button></a>
